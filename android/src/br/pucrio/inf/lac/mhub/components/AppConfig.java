...
public class AppConfig {
	 ...
	 * LOW    :: 1 minute
	 */
	public static final int DEFAULT_SCAN_INTERVAL_HIGH   = 1000 * 2;
	public static final int DEFAULT_SCAN_INTERVAL_MEDIUM = 1000 * 4;
	public static final int DEFAULT_SCAN_INTERVAL_LOW    = 1000 * 6;
