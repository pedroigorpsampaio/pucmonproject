...
import com.mygdx.game.AndroidSensor;
...
public class S2PAService extends Service implements TechnologyListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        startRouting();
        // show notification of service running
        showNotification();
		// if the service is killed by Android, service does not start again
    ...
    private void showNotification() {
        ...
        Intent notificationIntent = new Intent( S2PAService.this, AndroidLauncher.class );
    ...
    public void onMObjectFound( MOUUID mobileObject, Double rssi ) {
        ...
        AndroidSensor.getInstance().updateSensor( sensorData );
    }
